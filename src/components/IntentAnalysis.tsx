            ...
            >
              <div style={{ marginBottom: '16px', fontSize: '14px', color: '#6b7280' }}>
                <p style={{ marginBottom: '8px' }}>
                  <strong>📋 Transparency:</strong> Below are all the keywords used to categorize
                  conversations. Messages are matched against these keywords to determine their
                  topic category.
                </p>
                <p style={{ margin: 0 }}>
                  <strong>🔍 How it works:</strong> Each message is checked against all keyword
                  lists. If a message contains any keyword from a category, it gets assigned to that
                  category.
                </p>
              </div>
